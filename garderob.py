...
def get_compatible_items(user_items, chosen_item):
    ...
    compatibility_rules = {
        ...
        "Куртка": ["джинсы", "худи", "свитер", "кроссовки", "брюки", "ботинки", "шарф", "кеды", "шапка"],
        "Шуба": ["платье", "джинсы", "свитер", "сапоги", "клатч", "водолазка", "юбка", "сумка"],
        "Тренч": ["платье", "брюки", "юбка", "туфли", "балетки", "рубашка", "водолазка", "сумка", "шарф"],
        "Ветровка": ["джинсы", "спортивные брюки", "худи", "футболка", "кроссовки", "кеды", "шорты"],
        "Плащ": ["платье", "брюки", "юбка", "туфли", "сапоги", "шарф", "сумка"],
        "Бомбер": ["джинсы", "шорты", "кроссовки", "футболка", "худи", "кеды", "спортивные брюки"],
        ...
        "Джемпер": ["джинсы", "брюки", "юбка", "кроссовки", "ботинки", "сапоги", "шорты"],
        "Кофта": ["джинсы", "юбка", "брюки", "сапоги", "ботинки", "кроссовки", "шорты"],
        "Водолазка": ["брюки", "юбка-карандаш", "пиджак", "сапоги", "туфли", "юбка", "пальто", "платье"],
        "Свитер": ["джинсы", "брюки", "юбка", "кроссовки", "ботинки", "сапоги", "шорты", "пальто"],
        "Худи": ["джинсы", "шорты", "брюки", "кроссовки", "кеды", "юбка", "спортивные брюки"],

        # Рубашки и топы
        "Рубашка": ["брюки", "джинсы", "юбка", "пиджак", "кардиган", "туфли", "лоферы", "балетки"],
        "Топ": ["юбка", "брюки", "джинсы", "пиджак", "кардиган", "туфли", "балетки", "шорты"],
        "Майка": ["джинсы", "шорты", "юбка", "кардиган", "пиджак", "кроссовки", "кеды", "брюки"],
        "Поло": ["брюки", "джинсы", "шорты", "лоферы", "кроссовки", "юбка", "туфли"],
        "Корсет": ["юбка", "джинсы", "брюки", "сапоги", "туфли", "платье"],

        # Платья
        "Повседневное платье": ["кроссовки", "ботинки", "балетки", "кардиган", "туфли", "сапоги", "джинсовая куртка",
                                "кожанка"],
        "Вечернее платье": ["туфли на каблуке", "клатч", "украшения", "палантин", "босоножки"],
        ...
        # Костюмы
        "Костюм с юбкой": ["блузка", "топ", "рубашка", "туфли на каблуке", "балетки", "водолазка"],
        "Костюм с шортами": ["топ", "футболка", "блуза", "лоферы", "кроссовки", "туфли", "рубашка"],
        "Костюм с брюками": ["рубашка", "блузка", "топ", "туфли", "лоферы", "балетки", "водолазка"],

        # Обувь
        "Сапоги": ["джинсы", "брюки", "платье", "юбка", "свитер", "пальто", "куртка", "водолазка"],
        "Ботинки": ["джинсы", "брюки", "платье", "рубашка", "свитер", "пальто", "юбка", "куртка"],
        "Ботильоны": ["юбка", "платье", "джинсы", "колготки", "свитер", "пальто", "брюки"],
        "Кеды": ["джинсы", "шорты", "платье", "худи", "свитер", "футболка", "спортивные брюки", "юбка"],
        "Кроссовки": ["джинсы", "брюки", "шорты", "платье", "худи", "футболка", "спортивные брюки", "юбка"],
        "Туфли": ["платье", "юбка", "брюки", "рубашка", "топ", "пиджак", "костюм"],
        "Босоножки": ["платье", "юбка", "шорты", "джинсы", "топ", "блуза", "легкие брюки"],
        "Балетки": ["платье", "юбка", "брюки", "рубашка", "топ", "кардиган", "джинсы"],
        "Сандали": ["шорты", "юбка", "летнее платье", "топ", "майка", "блуза", "легкие брюки"],
        "Сланцы": ["шорты", "легкие брюки", "летнее платье", "пляжное платье"],
        "Тапки": ["домашние брюки", "шорты", "леггинсы", "домашнее платье"],
        "Кроксы": ["шорты", "джинсы", "легкие брюки", "спортивный костюм"],

        # Аксессуары
        "Головной убор": ["пальто", "куртка", "платье", "пуховик", "шуба", "ветровка"],
        "Шарф": ["пальто", "куртка", "свитер", "ветровка", "шуба", "тренч"],
        "Ремень": ["джинсы", "брюки", "платье", "юбка", "шорты"],
        "Большая сумка": ["пальто", "куртка", "платье", "брюки", "костюм", "повседневный образ"],
        "Маленькая сумка": ["вечернее платье", "деловой костюм", "праздничный образ", "свадебное платье"],
        "Украшения": ["любой образ", "платье", "костюм", "топ", "блуза", "свитер"],
    }
...
def get_pinterest_search_links(name, category):
    ...
    for word in name_words:
        ...
        for color in color_words:
            if color in word:
                is_color = True
                break
        if not is_color and len(word) > 2:
    ...
    style_keywords = {
        ...
        "джинсы": "jeans outfit",
        "пальто": "coat outfit",
        "куртка": "jacket outfit",
        "пиджак": "blazer outfit",
        "свитер": "sweater outfit",
        "худи": "hoodie outfit",
        "топ": "top outfit",
        "рубашка": "shirt outfit",
        "кофта": "sweater outfit",
        "шорты": "shorts outfit"
    }
